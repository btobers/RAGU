...
class gui(tk.Tk):
    ...
    #     self.key = self.fig.canvas.mpl_connect("key_press_event", imPick.imPick.onkey)
    #     self.click = self.fig.canvas.mpl_connect("button_press_event", imPick.imPick.addseg)
    #     self.f_loadName = ""
    #     self.dtype = "amp"
    #     self.var_reset()
    #     utils.open()
